...
@class LanSongColourFASTSamplingOperation;
@class LanSongBoxBlurFilter;

@interface LanSongColourFASTFeatureDetector : LanSongFilterGroup
{
    LanSongBoxBlurFilter *blurFilter;
    LanSongColourFASTSamplingOperation *colourFASTSamplingOperation;
}

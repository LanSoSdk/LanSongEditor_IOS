...
@class LanSongSingleComponentGaussianBlurFilter;
@class LanSongDirectionalSobelEdgeDetectionFilter;
@class LanSongDirectionalNonMaximumSuppressionFilter;
@class LanSongWeakPixelInclusionFilter;
 ...
 */
@interface LanSongCannyEdgeDetectionFilter : LanSongFilterGroup
{
    LanSongGrayscaleFilter *luminanceFilter;
    LanSongSingleComponentGaussianBlurFilter *blurFilter;
    LanSongDirectionalSobelEdgeDetectionFilter *edgeDetectionFilter;
    LanSongDirectionalNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
    LanSongWeakPixelInclusionFilter *weakPixelInclusionFilter;
}

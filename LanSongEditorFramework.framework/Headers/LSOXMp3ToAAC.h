...
@protocol LSOXMp3ToAACDelegate;

@interface LSOXMp3ToAAC : NSObject
...
/**
 ...
 @return 创建好的对象
 */
- (id)initWithDelegate:(id<LSOXMp3ToAACDelegate>)delegate source:(NSString*)srcPath destination:(NSString*)dstPath;
...
@protocol LSOXMp3ToAACDelegate <NSObject>
...
/**
 ...
 @param convert
 */
- (void)LanSongMp3ToAACDelegateCompleted:(LSOXMp3ToAAC*)convert;
...
/**
 ...
 @param error 错误描述
 */
- (void)LanSongMp3ToAACDelegateError:(LSOXMp3ToAAC*)converter error:(NSError*)error;
/**
 进度监听[可选]
 (一般很快完成, 也不建议使用.)
 ...
 */
- (void)LanSongMp3ToAACDelegateProgress:(LSOXMp3ToAAC*)converter progress:(CGFloat)progress;

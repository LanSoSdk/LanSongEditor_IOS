...
/*
 ...
 LSOLayoutParam *param2=[[LSOLayoutParam alloc] initWithURL:[LSOFileUtil URLForResource:@"h4OnePlus" withExtension:@"mp4"]];
 param2.scaleH=480;
 param2.scaleW=540;
 param2.x=0;
 param2.y=480;
 ...
 LSOLayoutParam *param3=[[LSOLayoutParam alloc] initWithURL:[LSOFileUtil URLForResource:@"iphoneX1080P" withExtension:@"mov"]];
 param3.x=500;
 param3.y=500;

...
@class LanSongSaturationFilter;
@class LanSongGaussianBlurFilter;
@class LanSongLuminanceRangeFilter;

@interface LanSongiOSBlurFilter : LanSongFilterGroup
{
    LanSongSaturationFilter *saturationFilter;
    LanSongGaussianBlurFilter *blurFilter;
    LanSongLuminanceRangeFilter *luminanceRangeFilter;
}

...
@interface LanSongHoughTransformLineDetector : LanSongFilterGroup
{
    LanSongOutput<LanSongInput> *thresholdEdgeDetectionFilter;
    
//    LanSongThresholdEdgeDetectionFilter *thresholdEdgeDetectionFilter;
    LanSongParallelCoordinateLineTransformFilter *parallelCoordinateLineTransformFilter;

...
/**
 提取视频帧;
 */
@interface LanSongExtractFrame : NSObject
 ...
 */
@property(nonatomic, copy) void(^extractCompletedBlock)(LanSongExtractFrame *v);
...
/**
 ...
 extractFrame=[[LanSongExtractFrame alloc] initWithPath:assetPath];
 if(extractFrame!=nil){

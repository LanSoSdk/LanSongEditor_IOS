...
typedef NS_ENUM(NSUInteger, LanSongSkinToneUpperColor) {
    LanSongSkinToneUpperColorGreen,
    LanSongSkinToneUpperColorOrange
};

extern NSString *const kLanSongSkinToneFragmentShaderString;

@interface LanSongSkinToneFilter : LanSongFilter
{
...
@property (nonatomic, readwrite) LanSongSkinToneUpperColor upperSkinToneColor;

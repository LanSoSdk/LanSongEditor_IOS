...
@class LanSongToonFilter;

/** This uses a similar process as the LanSongToonFilter, only it precedes the toon effect with a Gaussian blur to smooth out noise.
 */
@interface LanSongSmoothToonFilter : LanSongFilterGroup
{
    LanSongGaussianBlurFilter *blurFilter;
    LanSongToonFilter *toonFilter;
}

...
@interface LSOComposition : NSObject
...
@property (nonatomic, readonly, nullable) LSOLayerGroup *layerGroup;
@property (nonatomic, readonly, nullable) LSOAssetGroup *assetGroup;

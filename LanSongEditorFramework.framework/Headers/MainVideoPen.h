...
#import "MainVideoEncoder.h"

/** Protocol for getting Movie played callback.
 */
@protocol MainVideoPenDelegate <NSObject>
 ...
 */
@interface MainVideoPen : LanSongOutput
 ...
 */
@property (readwrite, nonatomic, assign) id <MainVideoPenDelegate>delegate;
...
- (void)enableSynchronizedEncodingUsingMovieWriter:(MainVideoEncoder *)movieWriter;
- (BOOL)readNextVideoFrameFromOutput:(AVAssetReaderOutput *)readerVideoTrackOutput;
- (BOOL)readNextAudioSampleFromOutput:(AVAssetReaderOutput *)readerAudioTrackOutput;
- (void)startProcessing;

- (void)prepare;
- (void)startProcessing2;

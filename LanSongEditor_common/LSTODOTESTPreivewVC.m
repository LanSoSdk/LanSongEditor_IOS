...
#import "LSTODOTESTPreivewVC.h"

#import "LanSongUtils.h"
#import "VideoPlayViewController.h"

@interface LSTODOTESTPreivewVC ()
{
    MediaInfo *mediaInfo;
...
@implementation LSTODOTESTPreivewVC
...
-(void)startPreview
{
    ...
    drawpadPreview=[[DrawPadVideoPreview alloc] initWithURL:[LanSongFileUtil filePathToURL:video] drawPadSize:self.view.frame.size];
   ...
   // videoPen.scaleWH=videoPen.drawPadSize.width/videoPen.penSize.width;

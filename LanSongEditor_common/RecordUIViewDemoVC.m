//
//  RecordUIViewDemoVC.m
//  LanSongEditor_all
//
//  Created by sno on 2018/11/13.
...
#import "LSDrawView.h"
@interface RecordUIViewDemoVC ()<StoryMakeToolsViewDelegate, StoryMakeStickerViewDelegate, StoryMakeStickerBaseViewDelegate, StoryMakeSelectColorFooterViewDelegate, StoryMakeFilterFooterViewDelegate>
{
    LSORecordUIPreview *recordUI;
    LSDrawView *drawView;
}
...
@property (nonatomic, strong) StoryMakeStickerView *stickerFooterView;  //选择贴纸界面;
@property (nonatomic, strong) StoryMakeSelectColorFooterView *colorFooterView;  //文字
@property (nonatomic, strong) StoryMakeFilterFooterView *filterFooterView; //选择滤镜界面??
...
@implementation RecordUIViewDemoVC
...
- (void)configureView
{
    ...
    recordUI=[[LSORecordUIPreview alloc] initWithView:self.drawImgView recordSize:CGSizeMake(540, 960) frameRate:15];
    [recordUI startRecord];
    
    // up layer tools
    [self.view addSubview:self.cancelBtn];
    [self.view addSubview:self.confirmBtn];
    [self.view addSubview:self.toolsBtnView];
    [self.view addSubview:self.stickerFooterView]; //贴纸
...
- (UIButton *)confirmBtn {
    if(!_confirmBtn) {
        ...
        [_confirmBtn setTitle:@"开始录制" forState:UIControlStateNormal];
